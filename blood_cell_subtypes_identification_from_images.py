# -*- coding: utf-8 -*-
"""Blood Cell Subtypes Identification from Images.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ciHMWExnVy4DX6c5YNrbDQ5hXlxunfAZ
"""
...
image = cv2.imread("/content/BloodImage_00000.jpg")
tree = ET.parse("/content/BloodImage_00000.xml")
...
def plotImage(image_location):
    ...
    plt.imshow(image)
    return
image_name = '/content/BloodImage_00207.jpg'
plt.figure(figsize=(16,16))
plt.subplot(221)
plt.title('Eosinophil')
plt.axis('off')
plotImage(image_name)
image_name = '/content/BloodImage_00204.jpg'
plt.subplot(222)
plt.title('Lymphocyte')
plt.axis('off')
plotImage(image_name)
image_name = '/content/BloodImage_00180.jpg'
plt.subplot(223)
plt.title('Monocyte')
plt.axis('off')
plotImage(image_name)
plt.subplot(224)
image_name = '/content/BloodImage_00292.jpg'
plt.title('Neutrophil')
plt.axis('off')
plotImage(image_name)

reader = csv.reader(open('/content/labels.csv'))
# skip the header
next(reader)
X3 = []
y3 = []
